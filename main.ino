...
uint8_t devEui[] = {0x70, 0xB3, 0xD5, 0x49, 0x98, 0x9E, 0x93, 0xDF}; 
uint8_t appEui[] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x04, 0x15, 0x1E};
uint8_t appKey[] = {0xA9, 0x07, 0xE5, 0x52, 0xEE, 0x7B, 0xE2, 0xBB, 0x3C, 0x8E, 0x64, 0xBE, 0x59, 0x1F, 0x35, 0x57};
